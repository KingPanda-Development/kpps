...
const serverless = require('serverless-http'); // penting buat vercel
...
app.all('/player/login/dashboard', function (req, res) {
    ...
    res.send(tData); // karena render ejs ga jalan di vercel
});
...
module.exports = app;
module.exports.handler = serverless(app); // wajib buat vercel
